...
// Web Push subscriptions, keyed to a persistent player identity (players.id)
// rather than a game -- a player keeps the same subscription across every
// friend game they play on that device
...
db.exec(PUSH_SUBSCRIPTIONS_TABLE)
...
db.exec('CREATE INDEX IF NOT EXISTS idx_push_subscriptions_player ON push_subscriptions (player_id)')
