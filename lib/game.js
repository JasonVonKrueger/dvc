...
let { generatePlayerName } = require('./names.js')

module.exports = class Game {
    constructor(type, playerOneName) {
        ...
        this.playerOne = {
            name: playerOneName || generatePlayerName(),
            joined: false,
            isBot: false,
            score: 0,
            remainingOvals: 45,
        ...
        this.playerTwo = {
            name: generatePlayerName([this.playerOne.name]),
            joined: false,
            isBot: false,
            score: 0,
            remainingOvals: 45,
    ...
    _generateGameID = function(length) {
        let id = ''
        // uppercase-only so client-side auto-uppercasing of join codes always matches
